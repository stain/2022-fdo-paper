...
In table [@tbl:fdo-web-interoperability-framework] we compare the current FAIR Digital Object approach against the Web using Linked Data practices by using this interoperability framework.
