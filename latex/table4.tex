...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.4179}}@{}}
\caption{Comparing FAIR Digital Object (with the DOIP 2.0 protocol \autocite{foundationDigitalObjectInterface}) and Web technologies (using Linked Data) as middleware infrastructures \autocite{zarrasComparisonFrameworkMiddleware2004a}
