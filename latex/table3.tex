...
FDOF1: \emph{PID as basis}
  ...
  & Clarify how local testing handles can be used during development, how ``temporary'' FDOs should evolve \autocite{fdo-PIDProfileAttributes}. Register \texttt{0.DOIP/*} and \texttt{0.FDO/*} as PIDs.
